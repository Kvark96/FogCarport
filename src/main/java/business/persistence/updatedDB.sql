...
INSERT INTO `carport`.`materials` (`materials_id`, `name`, `length`, `description`)
...
INSERT INTO `carport`.`materials` (`materials_id`, `name`, `description`)
...
INSERT INTO `carport`.`materials` (`materials_id`, `name`, `length`, `amount`)
VALUES ('12', 'hulbånd 1x20 mm. 10 mtr.  Til vindkryds på spær', '1000', '2');
INSERT INTO `carport`.`materials` (`materials_id`, `name`)
...
INSERT INTO `carport`.`materials` (`materials_id`, `name`, `amount`)
