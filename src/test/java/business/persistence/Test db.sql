...
VALUES ('1', '25x200 mm. trykimp. Brædt 360  understernbrædder til for & bag ende', '360', '4',
        'Tilskæres ved montage');
INSERT INTO `carport_test`.`materials` (`materials_id`, `name`, `length`, `amount`, `description`)
VALUES ('2', '25x200 mm. trykimp. Brædt 540 understernbrædder til siderne', '540', '4', 'Tilskæres ved montage');
INSERT INTO `carport_test`.`materials` (`materials_id`, `name`, `length`, `amount`, `description`)
VALUES ('3', '25x125mm. trykimp. Brædt 360 oversternbrædder til forenden', '360', '2', 'Tilskæres ved montage');
INSERT INTO `carport_test`.`materials` (`materials_id`, `name`, `length`, `amount`, `description`)
VALUES ('4', '25x125mm. trykimp. Brædt 540 oversternbrædder til siderne', '540', '4', 'Tilskæres ved montage');
INSERT INTO `carport_test`.`materials` (`materials_id`, `name`, `length`, `amount`, `description`)
VALUES ('5', '45x195 mm. spærtræ ubh.', '0', '2', 'Remme i sider, sadles ned i stolper');
INSERT INTO `carport_test`.`materials` (`materials_id`, `name`, `length`, `description`)
VALUES ('6', '45x195 mm. spærtræ ubh', '0', 'Spær, monteres på rem');
INSERT INTO `carport_test`.`materials` (`materials_id`, `name`, `length`, `description`)
VALUES ('7', '97x97 mm. trykimp. Stolpe 300', '300', 'nedgraves 90 cm i jord');
INSERT INTO `carport_test`.`materials` (`materials_id`, `name`, `length`, `amount`, `description`)
VALUES ('8', '19x100 mm. trykimp. Brædt 540 vandbrædt på stern i sider', '540', '4', 'Tilskæres ved montage');
INSERT INTO `carport_test`.`materials` (`materials_id`, `name`, `length`, `amount`, `description`)
VALUES ('9', '19x100 mm. trykimp. Brædt 360 vandbrædt på stern i forende', '360', '2', 'Tilskæres ved montage');
INSERT INTO `carport_test`.`materials` (`materials_id`, `name`, `description`)
VALUES ('10', 'Plastmo Ecolite blåtonet', 'Tilskæres ved montage');
INSERT INTO `carport_test`.`materials` (`materials_id`, `name`, `description`)
...
VALUES ('12', 'hulbånd 1x20 mm. 10 mtr.  Til vindkryds på spær', '1000', '2');
INSERT INTO `carport_test`.`materials` (`materials_id`, `name`)
VALUES ('13', 'universal 190 mm højre  Til montering af spær på rem');
INSERT INTO `carport_test`.`materials` (`materials_id`, `name`)
VALUES ('14', 'universal 190 mm venstre Til montering af spær på rem');
INSERT INTO `carport_test`.`materials` (`materials_id`, `name`, `amount`)
VALUES ('15', '4,5 x 60 mm. skruer 200 stk. 1 Pakke Til montering af stern&vandbrædt', '1');
INSERT INTO `carport_test`.`materials` (`materials_id`, `name`, `amount`)
VALUES ('16', '4,0 x 50 mm. beslagskruer 250', '1');
INSERT INTO `carport_test`.`materials` (`materials_id`, `name`, `description`)
VALUES ('17', 'bræddebolt 10 x 120 mm. Til montering af rem på stolper', '2 per stolpe');
INSERT INTO `carport_test`.`materials` (`materials_id`, `name`, `description`)
VALUES ('18', 'firkantskiver 40x40x11mm Til montering af rem på stolper', '2 per stolpe');
...
UPDATE `carport_test`.`materials` SET `name` = 'Universal 190 mm venstre', `description` = 'Til montering af spær på rem' WHERE (`materials_id` = '14');
UPDATE `carport_test`.`materials` SET `name` = 'Universal 190 mm højre', `description` = 'Til montering af spær på rem' WHERE (`materials_id` = '13');
UPDATE `carport_test`.`materials` SET `name` = 'Hulbånd 1x20 mm. 10 mtr.  ', `description` = 'Til vindkryds på spær' WHERE (`materials_id` = '12');
UPDATE `carport_test`.`materials` SET `name` = 'Plastmo bundskruer 200 stk.', `description` = 'Skruer til tagplader' WHERE (`materials_id` = '11');
UPDATE `carport_test`.`materials` SET `name` = '4, 5 x 60 mm. skruer 200 stk.', `description` = 'Til montering af stern&vandbrædt' WHERE (`materials_id` = '15');
UPDATE `carport_test`.`materials` SET `name` = '4, 0 x 50 mm. beslagskruer 250 stk.', `description` = 'Til montering af universalbeslag + hulbånd' WHERE (`materials_id` = '16');
UPDATE `carport_test`.`materials` SET `name` = 'Bræddebolt 10 x 120 mm', `description` = 'Til montering af rem på stolper' WHERE (`materials_id` = '17');
UPDATE `carport_test`.`materials` SET `name` = 'Firkantskiver 40x40x11mm', `description` = 'Til montering af rem på stolper' WHERE (`materials_id` = '18');
UPDATE `carport_test`.`materials` SET `name` = '25x200 mm. trykimp. Brædt', `description` = 'Understernbrædder til for & bag ende' WHERE (`materials_id` = '1');
UPDATE `carport_test`.`materials` SET `name` = '25x200 mm. trykimp. Brædt', `description` = 'Understernbrædder til siderne' WHERE (`materials_id` = '2');
UPDATE `carport_test`.`materials` SET `name` = '25x125mm. trykimp. Brædt', `description` = 'Oversternbrædder til forenden' WHERE (`materials_id` = '3');
UPDATE `carport_test`.`materials` SET `name` = '25x125mm. trykimp. Brædt', `description` = 'Oversternbrædder til siderne' WHERE (`materials_id` = '4');
UPDATE `carport_test`.`materials` SET `name` = '19x100 mm. trykimp. Brædt', `description` = 'Vandbrædt på stern i sider' WHERE (`materials_id` = '8');
UPDATE `carport_test`.`materials` SET `name` = '97x97 mm. trykimp. Stolpe' WHERE (`materials_id` = '7');
UPDATE `carport_test`.`materials` SET `name` = '19x100 mm. trykimp. Brædt ', `description` = 'Vandbrædt på stern i forende' WHERE (`materials_id` = '9');
UPDATE `carport_test`.`materials` SET `description` = 'Tagplader monteres på spær' WHERE (`materials_id` = '10');
